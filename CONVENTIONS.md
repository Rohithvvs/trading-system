...
3. MOCK EXTERNAL APIS: When writing tests, always mock external live market APIs (like FYERS). Tests must run offline without hitting rate limits.
...
3. NO RAW ERRORS: Catch exceptions globally, log to the database/stdout, and return clean 500 JSON responses.