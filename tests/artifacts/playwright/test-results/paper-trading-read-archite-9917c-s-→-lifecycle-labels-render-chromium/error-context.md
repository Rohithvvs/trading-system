...
- Name: paper-trading-read-architecture.spec.ts >> Paper Trading Read Architecture >> place order → position appears → reload persists → lifecycle labels render
- Location: e2e\paper-trading-read-architecture.spec.ts:19:3
